	...
	<div class="container">
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2 box">
				<h1><spring:message code="homepage.add.computer"/></h1>
				<form action="addComputer" method="POST">
					<fieldset>
						<div class="form-group">
							<label for="computerName"><spring:message code="computer.name"/></label> <input
								type="text" class="form-control" name="<spring:message code="computer.name"/>" required
								id="computerName" placeholder="<spring:message code="computer.name"/>">
						</div>
						<div class="form-group">
					...
					<div class="actions pull-right">
						<input type="submit" value="<spring:message code="addpage.add"/>" id="submit"
