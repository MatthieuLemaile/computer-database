...
public class TestComputer {
    ...
    // Computer.Builder(name).id(5).introduced(introduced).discontinued(discontinued).company(company).build();
    ...
    // assertEquals("The discontinued date is not set
    // properly",discontinued,computer.getDiscontinued());
    // }
    //
    // @Test(expected=IllegalArgumentException.class)
